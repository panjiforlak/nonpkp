        ...
        <div class="panel panel-bd">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <label><?php echo display('purchase_key') ?> <span class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="bottom" title="Enter Envato purchase key or japasys purchase key"></span></label>
                ...
                <div class="row">
                    ...
                    $def_mods = ['dashboard', 'template', 'addon', 'account', 'bank', 'customer', 'hrm', 'invoice', 'purchase', 'tax', 'report', 'product', 'quotation', 'return', 'service', 'supplier', 'payrol', 'autoupdate'];
                    if (is_array($map))
