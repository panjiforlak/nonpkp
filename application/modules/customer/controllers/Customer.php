...
class Customer extends MX_Controller
{
    ...
    public function japasys_CheckCustomerList()
    {
    ...
    public function japasys_credit_customer()
    {
        $data['title']             = display('credit_customer');
        $data['module']            = "customer";
        $data['page']              = "credit_customer";
        $data["customer_dropdown"] = $this->customer_model->japasys_credit_customer_dropdown();
        $data['all_customer']      = $this->customer_model->japasys_all_credit_customer();
        echo modules::run('template/layout', $data);
    }

    public function japasys_CheckCreditCustomerList()
    {
    ...
    public function japasys_paid_customer()
    {
        $data['title']             = display('paid_customer');
        $data['module']            = "customer";
        $data['page']              = "paid_customer";
        $data["customer_dropdown"] = $this->customer_model->japasys_paid_customer_dropdown();
        $data['all_customer']      = $this->customer_model->japasys_all_paid_customer();
        echo modules::run('template/layout', $data);
    }

    public function japasys_CheckPaidCustomerList()
    {
        // GET data
        $postData = $this->input->post();
        $data = $this->customer_model->japasys_getPaidCustomerList($postData);
        echo json_encode($data);
    }


    public function japasys_form($id = null)
    {
        ...
        $data['customer'] = (object)$postData = [
            ...
            'limit'            => intval(str_replace('.', '', $this->input->post('limit', true))),
            'status'           => 1,
    ...
    public function japasys_delete($id)
    {
    ...
    public function japasys_customer_ledger()
    {
    ...
    public function japasys_customer_ledgerData()
    {
    ...
    public function japasys_customer_advance()
    {
