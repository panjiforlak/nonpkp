     ...
     <div class="col-sm-12">
         <div class="panel panel-bd lobidrag">
             ...
             <div class="panel-body">
                 ...
                 <div class="form-group row">
                     ...
                     <div class="col-sm-4">
                         <div class="">
                             ...
                             <input type="text" class="form-control" name="email_address" id="email_address" placeholder="<?php echo display('vat_no') ?>" value="<?php echo $customer->email_address ?>">
                 ...
                 <div class="form-group row">
                     ...
                     <div class="col-sm-4">
                         <div class="">
                             ...
                             <input class="form-control" id="contact" type="text" name="contact" placeholder="<?php echo display('cr_no') ?>" value="<?php echo $customer->contact ?>">
                 ...
                 <div class="form-group row">
                     <label for="country" class="col-sm-2 text-right col-form-label">Limit Saldo:</label>
                     <div class="col-sm-4">
                         <div class="">

                             <input name="limit" onkeypress="return event.charCode >= 48 && event.charCode <=57" type="text" class="form-control " placeholder="0" value="<?php echo number_format($customer->limit, 0, ",", ".") ?>" id="tanpa-rupiah" maxlength="18">
