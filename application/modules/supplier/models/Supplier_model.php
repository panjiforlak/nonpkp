...
class Supplier_model extends CI_Model
{
    ...
    public function supplier_list($offset = null, $limit = null)
    {
        ...
        return $result = $this->db->select("a.*,b.HeadCode,((select ifnull(sum(Debit),0) from acc_transaction where COAID= `b`.`HeadCode`)-(select ifnull(sum(Credit),0) from acc_transaction where COAID= `b`.`HeadCode`)) as balances")
