...
class Supplier extends MX_Controller
{
    ...
    public function japasys_ChecksupplierList()
    {
    ...
    public function japasys_supplier_ledger()
    {
    ...
    public function japasys_supplier_ledgerData()
    {
    ...
    public function japasys_supplier_advance()
    {
    ...
    public function japasys_supplier_ledgerinfo($supplier_id)
    {
        $supplier_details = $this->supplier_model->supplier_personal_data($supplier_id);
