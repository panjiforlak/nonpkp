...
$route['add_service']           = "service/service/japasys_service_form";
$route['manage_service']        = "service/service/japasys_manage_service";
$route['edit_service/(:num)']   = "service/service/japasys_edit_service/$1";
$route['add_service_invoice']   = "service/service/japasys_service_invoice_form";
