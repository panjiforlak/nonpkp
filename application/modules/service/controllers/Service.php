...
class Service extends MX_Controller
{
    ...
    public function japasys_service_form()
    {
    ...
    public function japasys_manage_service()
    {
    ...
    public function japasys_edit_service($service_id)
    {
    ...
    public function japasys_service_invoice_form()
    {
        $data = array(
