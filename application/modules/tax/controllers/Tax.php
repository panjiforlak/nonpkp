...
class Tax extends MX_Controller
{
    ...
    // ============== Tax settings ================
    public function japasys_tax_settings()
    {
    ...
    public function japasys_vat_tax_settings()
    {
    ...
    public function japasys_income_tax()
    {
    ...
    // ================ Income tax entry   ======
    public function japasys_create_income_tax()
    {
