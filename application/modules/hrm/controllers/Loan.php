...
class Loan extends MX_Controller
{
    ...
    public function japasys_add_office_loan_person()
    {
    ...
    public function japasys_add_office_loan()
    {
    ...
    public function japasys_insert_office_loan()
    {
    ...
    public function japasys_add_office_loan_payment()
    {
    ...
    public function japasys_submit_payment()
    {
        $personid       = $this->input->post('person_id', TRUE);
        $personinfo     = $this->db->select('person_name')->from('person_information')->where('person_id', $personid)->get()->row();
        $headname       = $personid . '-' . $personinfo->person_name;
    ...
    public function japasys_edit_office_person($person_id)
    {
    ...
    public function japasys_add_person()
    {
        $data['title']      = display('add_person');
        $data['module']     = "hrm";
    ...
    public function japasys_submit_person()
    {
        $person_id = $this->occational->generator(10);
        $data = array(
            'person_id'      => $person_id,
    ...
    public function japasys_personal_ledger($person_id)
    {
    ...
    public function japasys_personal_loan_summary()
    {
    ...
    public function japasys_add_loan()
    {
    ...
    public function japasys_submit_loan()
    {
        $transaction_id = $this->occational->generator(10);
        $data = array(
            'transaction_id' => $transaction_id,
    ...
    public function japasys_add_payment()
    {
        $data['title']       = display('add_payment');
        $data['person_list'] = $this->loan_model->person_list_personal_loan();
        $data['module']      = "hrm";
    ...
    public function japasys_submit_personal_payment()
    {
        $transaction_id = $this->occational->generator(10);
        $data = array(
            'transaction_id' => $transaction_id,
