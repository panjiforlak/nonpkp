...
class Expense extends MX_Controller
{
    ...
    public function japasys_expense_item_list()
    {
    ...
    public function japasys_expense_item_form($id = null)
    {
    ...
    public function japasys_add_expense()
    {
    ...
    public function japasys_create_expense()
    {
