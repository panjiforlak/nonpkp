...
class Hrm extends MX_Controller
{
    ...
    public function japasys_designation_list()
    {
    ...
    public function japasys_designation_form($id = null)
    {
    ...
    public function japasys_deletedesignation($id = null)
    {
    ...
    /*employee part start*/
    public function japasys_employee_form($id = null)
    {
    ...
    public function japasys_employee_list()
    {
    ...
    public function japasys_employee_profile($id)
    {
    ...
    public function japasys_delete_employee($id = null)
    {
