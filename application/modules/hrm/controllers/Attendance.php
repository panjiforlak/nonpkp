...
class Attendance extends MX_Controller
{
    ...
    public function japasys_add_attendance()
    {
    ...
    public function japasys_create_atten()
    {
    ...
    public function japasys_edit_attendance($id = null)
    {
    ...
    public function japasys_delete_attendance($id = null)
    {
    ...
    // attendance report
    public function japasys_attendance_report()
    {
    ...
    public function japasys_datewiseattendancereport()
    {
        $data['title']      = display('attendance_report');
