                         ...
                         <div class="col-sm-12">
                             ...
                             <table>
                                 <tr>
                                     ...
                                     <td class="text-center payslipadd">
                                         <address class="margin-top10">
                                             <strong class="font30"><?php echo (!empty($company[0]['company_name']) ? $company[0]['company_name'] : 'japasys Ltd') ?></strong><br>
                                     ...
                                     <td class="left-panel borderright">
                                         <table class="" width="100%">
                                             ...
                                             <tbody class="details">
                                                 ...
                                                 <tr class="entry">
                                                     <td class="value"><?php if ($paymentdata[0]['salarytype'] == 1) {
                                                                            echo display('basic_salary');
                                                                        } else {
                                                                            echo display('basic_salary');
                                                                        } ?></td>
                                                     <td class="value">
                                                         <div><?php if ($paymentdata[0]['salarytype'] == 1) {
