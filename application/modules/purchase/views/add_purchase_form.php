    ...
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                <?php echo form_open_multipart('purchase/purchase/japasys_save_purchase', array('class' => 'form-vertical', 'id' => 'insert_purchase', 'name' => 'insert_purchase')) ?>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            <label for="date" class="col-sm-4 col-form-label"><?php echo display('due_date') ?>

                            </label>

                            <div class="col-sm-6">
                                <?php $date = date('Y-m-d'); ?>
                                <input type="text" required tabindex="2" class="form-control datepicker" name="due_date" value="<?php echo $date; ?>" id="date2" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered table-hover" id="purchaseTable">
                        ...
                        <tbody id="addPurchaseItem">
                            <tr>
                                <td class="span3 supplier">
                                    <input type="text" name="product_name" autocomplete="off" required class="form-control product_name productSelection" onkeypress="product_pur_or_list(1);" placeholder="Search Product" id="product_name_1" tabindex="5">
                                ...
                                <td class="wt">
                                    <input type="text" id="expiry_date_1" class="form-control expiry_date_1" placeholder="Expiry Date" name="expiry_date[]" />
                                </td>
                                ...
                                <!-- Discount start-->
                                <td>
                                    <input type="text" name="discount_per[]" onkeyup="calculate_store(1);" onchange="calculate_store(1);" id="discount_1" class="form-control text-right" min="0" tabindex="11" placeholder="0.00" />
                                    <input type="hidden" value="<?php echo $discount_type ?>" name="discount_type" id="discount_type_1">

                                </td>
                                <td>
                                    <input type="text" name="discountvalue[]" id="discount_value_1" class="form-control text-right total_discount_val" min="0" tabindex="12" placeholder="0.00" readonly />
                                </td>
                                <!-- Discount end-->
                                <!-- VAT  start-->
                                <td>
                                    <input type="text" name="vatpercent[]" onkeyup="calculate_store(1);" onchange="calculate_store(1);" id="vat_percent_1" class="form-control text-right" min="0" tabindex="13" placeholder="0.00" />


                                </td>
                                <td>
                                    <input type="text" name="vatvalue[]" id="vat_value_1" class="form-control text-right total_vatamnt" min="0" tabindex="14" placeholder="0.00" readonly />
                                </td>
                                <!-- VAT  end-->
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" id="grandTotal" class="text-right form-control grandTotalamnt" name="grand_total_price" value="00" readonly />
                                </td>
                                <td> </td>
                            </tr>
                            <tr>
