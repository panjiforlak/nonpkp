...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <?php echo form_open_multipart('purchase/purchase/japasys_update_purchase', array('class' => 'form-vertical', 'id' => 'purchase_update')) ?>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <?php $date = date('Y-m-d'); ?>
                                <input type="text" required tabindex="2" class="form-control datepicker" name="due_date" value="<?php echo $due_date; ?>" id="date2" />
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    foreach ($multi_paytype as $all_paytype) { ?>
                                        <div class="row no-gutters">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" id="pamount_by_method" class="form-control number pay firstpay" name="pamount_by_method[]" value="<?php echo $all_paytype->Credit ?>" onkeyup="changedueamount()" placeholder="0" />
