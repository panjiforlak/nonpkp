    ...
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                <?php echo form_open_multipart('invoice/invoice/japasys_manual_sales_insert', array('class' => 'form-vertical', 'id' => 'insert_sale', 'name' => 'insert_sale')) ?>
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            <label for="date" class="col-sm-3 col-form-label">Salesman<i class="text-danger"></i></label>
                            <div class="col-sm-6">
                                <select name="sales_by" class="form-control " id="sales_by">
                                    <option value="">Select option</option>
                                    <?php foreach ($salesman as $gs) { ?>
                                        <option value="<?php echo html_escape($gs['user_id']) ?>">
                                            <?php echo html_escape($gs['first_name'] . ' ' . $gs['last_name']); ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            <label for="invoice_no" class="col-sm-3 col-form-label"><?php
                                                                                    ...
                                                                                    ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input class="form-control" type="text" name="invoice_no" id="invoice_no" required value="INV/SO/<?php echo date('Ymd') . '/' . html_escape($invoice_no); ?>" readonly />
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered table-hover" id="normalinvoice">
                        ...
                        <tbody id="addinvoiceItem">
                            <tr>
                                ...
                                <!-- <td> -->
                                <input type="hidden" name="desc[]" class="form-control text-right " tabindex="6" />
                                <!-- </td> -->
                                ...
                                <td>
                                    <input type="text" name="product_quantity[]" required="" onkeyup="japasys_invoice_quantity_calculate(1);" onchange="japasys_invoice_quantity_calculate(1);" onkeypress="return event.charCode >= 48 && event.charCode <=57" class="total_qntt_1 form-control text-right" id="total_qntt_1" placeholder="0" min="0" tabindex="8" value="1" />
                                </td>
                                <td class="invoice_fields">
                                    <input type="text" name="product_rate[]" id="price_item_1" class="price_item1 price_item form-control text-right" tabindex="9" required="" onkeyup="japasys_invoice_quantity_calculate(1);" onkeypress="return event.charCode >= 48 && event.charCode <=57" onchange="japasys_invoice_quantity_calculate(1);" placeholder="0" min="0" />
                                </td>
                                <!-- Discount -->
                                <td>
                                ...
                                <input type="hidden" name="discountvalue3[]" id="discount_value3_1" class="form-control text-right" min="0" tabindex="18" placeholder="0" readonly />

                                <!-- end discount -->
                                <td class="invoice_fields">
                                    <input class="total_price form-control text-right" type="text" name="total_price[]" id="total_price_1" value="0" readonly="readonly" />
                                </td>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" id="total_discount2_1" class="" />
                                    <input type="hidden" id="all_discount2_1" class="total_discount dppr" name="discount_amount[]" />
                                    <input type="hidden" id="total_discount3_1" class="" />
                                    <input type="hidden" id="all_discount3_1" class="total_discount dppr" name="discount_amount[]" />
                        ...
                        <tfoot>
                            ...
                            <input type="hidden" id="total_vat_amnt" name="total_vat_amnt" value="0" />
                            <?php $x = 0;
                            foreach ($taxes as $taxfldt) { ?>
                                ...
                                <tr class="hideableRow hiddenRow">
                                    ...
                                    <td class="text-right">
                                        <input id="total_tax_ammount<?php echo $x; ?>" tabindex="-1" class="form-control text-right valid totalTax" name="total_tax<?php echo $x; ?>" value="0" readonly="readonly" aria-invalid="false" type="text">
                                    </td>
                                </tr>
                            <?php $x++;
                            } ?>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <input id="total_tax_amount" tabindex="-1" class="form-control text-right valid" name="total_tax" value="0" readonly="readonly" aria-invalid="false" type="text">
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" id="shipping_cost" class="form-control text-right" name="shipping_cost" onkeypress="return event.charCode >= 48 && event.charCode <=57" onkeyup="japasys_invoice_quantity_calculate(1);" onchange="japasys_invoice_quantity_calculate(1);" placeholder="0" tabindex="14" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="9" class="text-right"><b><?php echo display('grand_total') ?>:</b></td>
                                <td class="text-right">
                                    <input type="text" id="grandTotal" class="form-control text-right grandTotalamnt" name="grand_total_price" value="0" readonly="readonly" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="9" class="text-right"><b><?php echo display('previous'); ?>:</b></td>
                                <td class="text-right">
                                    <input type="text" id="previous" class="form-control text-right" name="previous" value="0" readonly="readonly" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="text-right text-success" colspan="9"><b><?php echo display('paid_ammount') ?>:</b></td>
                                <td class="text-right">
                                    <input type="hidden" name="baseUrl" class="baseUrl" value="<?php echo base_url(); ?>" />
                                    <input type="text" id="paidAmount" onkeypress="return event.charCode >= 48 && event.charCode <=57" onkeyup="invoice_paidamount();" class="form-control text-right" name="paid_amount" placeholder="0" tabindex="15" value="" />
                                </td>
                            </tr>
                            <tr>
...
<script>
    ...
    function change() {
        ...
        if (x !== "0") {
            document.getElementById("paidAmount").value = document.getElementById("n_total").value;
            document.getElementById("pamount_by_method").value = document.getElementById("n_total").value;
        } else {
            document.getElementById("paidAmount").value = 0;
            document.getElementById("pamount_by_method").value = 0;
        }
    }
</script>