        ...
        <div class="tab-pane fade active in" id="home">
            <div class="row">
                                                ...
                                                <div class="product-panel overflow-hidden border-0 shadow-sm" id="image-active_<?php echo $item->product_id ?>">
                                                    <div class="item-image position-relative overflow-hidden">
                                                        <div class="" id="image-active_count_<?php echo $item->product_id ?>">
                                                            <span id="active_pro_<?php echo $item->product_id ?>" class="active_qty"></span>
                                                        </div>
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <?php echo form_open_multipart('invoice/invoice/japasys_manual_sales_insert', array('class' => 'form-vertical', 'id' => 'gui_sale_insert', 'name' => 'insert_pos_invoice')) ?>
                    <div class="d-flex align-items-center mb-5">
                        <div class="input-group mr-3">
                            <input type="text" class="form-control customerSelection" id="customer_name" value="<?php echo $customer_name; ?>" placeholder="<?php echo display('customer_name'); ?>" tabindex="3" onkeyup="customer_autocomplete()" name="customer_name">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="invoice-no" id="gui_invoice_no">
                                INV/SO/<?php echo date('Ymd') . '/' . html_escape($invoice_no); ?>
                            </div>
                            <input class="form-control" type="hidden" name="invoice_no" id="invoice_no" required value="INV/SO/<?php echo date('Ymd') . '/' . html_escape($invoice_no); ?>" readonly />
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered table-hover table-sm nowrap gui-products-table" id="addinvoice">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center invoice_fields"><?php echo display('batch_no') ?><i class="text-danger">*</i></th>
                    ...
                    <div class="footer">
                        ...
                        <div class="form-group row guifooterpanel">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6 col-lg-5 col-xl-4">
                                    <input type="text" id="total_discount_ammount" class="form-control gui-foot text-right" name="total_discount" value="0.00" readonly="readonly" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group row guifooterpanel">
                            <div class="col-sm-12">
                                <label for="date" class="col-sm-6 col-lg-6 col-xl-7 col-form-label"><?php echo display('ttl_val') ?>:</label>
                                <div class="col-sm-6 col-lg-5 col-xl-4">
                                    <input type="text" id="total_vat_amnt" class="form-control gui-foot text-right" name="total_vat_amnt" value="0.00" readonly="readonly" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group row guifooterpanel">
                        ...
                        <div class="form-group row guifooterpanel">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6 col-lg-5 col-xl-4"><input type="text" id="grandTotal" class="form-control gui-foot text-right grandTotalamnt" name="grand_total_price" value="0.00" readonly="readonly" />
