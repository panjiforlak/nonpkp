                     ...
                     <table width="100%" class="table-striped">
                         <thead>
                             <tr class="pthead">
                                 ...
                                 <th align="center"><?php if ($is_unit != 0) {
                                                        echo display('unit');
                                                    } ?></th>
                                 <td><?php if ($is_desc != 0) {
                                            echo display('item_description');
                                        } ?></td>
                                 <td><?php if ($is_serial != 0) {
                                            echo display('serial_no');
                                        } ?></td>
                                 <td align="right"><?php echo display('quantity'); ?></td>
                                 <td align="right"><?php if ($is_discount > 0) {
                                                        echo display('discount');
                                                    } else {
                                                        echo '';
                                                    } ?></td>
                                 <th class="text-right"><?php if ($is_dis_val > 0) {
                                                            echo display('dis_val');
                                                        } else {
                                                            echo '';
                                                        } ?></th>
                                 <th class="text-right"><?php if ($vat_amnt_per > 0) {
                                                            echo display('vat') . ' %';
                                                        } else {
                                                            echo '';
                                                        } ?></th>
                                 <th class="text-right"><?php if ($vat_amnt > 0) {
                                                            echo display('vat_val');
                                                        } else {
                                                            echo '';
                                                        } ?></th>
                             ...
                             <?php
                                ...
                                foreach ($invoice_all_data as $invoice_data) { ?>
                                 <tr>
                                     ...
                                     <td align="left">
                                         <nobr><?php echo html_escape($invoice_data['description']); ?></nobr>
                                     </td>
                                     <td align="left">
                                         <nobr><?php echo html_escape($invoice_data['serial_no']); ?></nobr>
                                     </td>
                                     <td align="right">
                         ...
                         <tfoot>
                             <tr>
                                 <td colspan="12" class="minpos-bordertop">
                                     <nobr></nobr>
                                 </td>
                             </tr>
                             <tr>
                             ...
                             <tr>
                                 ...
                                 <td colspan="9" style="font-style: italic;"><span align="right"><b><?php echo display('in_word') . ' : ' ?></b><?php echo $am_inword ?></span> Rupiah</td>
                                 <td align="right"><strong><?php echo display('grand_total') ?></strong></td>
