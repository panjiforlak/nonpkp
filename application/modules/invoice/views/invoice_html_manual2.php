        ...
        <div class="panel panel-bd">
            <div id="printableArea">
                <div class="panel-body">
                    <div class="invoice-wrap" style="max-width:272.12598425px;background:#fff;margin-right:auto;margin-left:auto;font-size:14px;color:#5b5b5b">
                        <div style="text-align: center; margin-bottom: 10px;">
                            <div style="border: 1px solid #000;font-weight: 700;font-size: 17px;color: #000;">
                                <?php echo $company_info[0]['company_name'] ?></div>
                        </div>

                        <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="color: #000;font-size: 11px;margin-bottom: 10px;">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="color: #000;font-size: 11px;border-collapse: collapse;margin-bottom: 10px;">
                            <thead>
                                <tr>
                                ...
                                <tr>
                                    <th colspan="7" style="border: 1px solid #000;">
                                        <div style="position: relative;">
                                            ...
                                            <div style="height: 1px;background-color: #fff;width: 100%;position: absolute;z-index: 9;top: 1px;left: 0;">
                                            </div>
                                        </div>
                                    </th>
                                </tr>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="color: #000;font-size: 11px;margin-bottom: 20px;">
                            <tbody>
                                <tr>
                                ...
                                <?php } ?>
                                <tr>
                                    <th style="text-align: left;"><span style="font-size: 16px;font-weight: 900;"><?php echo $paid_amount ?></span>
                                    </th>
                        ...
                        <div style="margin-bottom: 12px;">
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="color: #000;font-size: 13px;">
                                <thead>
                                    <tr align="center">
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                            <th style="text-align: center;">
                                                <?php if ($getway_wise_balance->debit != null) {
                                                    echo $getway_wise_balance->debit;
                                                } else {
                                                    echo '0.00';
                                                } ?>
                                            </th>
                        ...
                        <?php } ?>
                        <table width="70%" border="0" cellpadding="0" cellspacing="0" align="center" style="color: #000;font-size: 13px;margin-top: 20px;">
                            <tbody>
                                <tr>
