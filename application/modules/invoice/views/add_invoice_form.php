            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="normalinvoice">
                        <thead style="background-color:#f6f9ff;margin:3px">
                            <tr>
                        ...
                        <tbody id="addinvoiceItem">
                            <tr>
                                <td class="product_field">
                                    <input type="text" required name="product_name" autocomplete="off" onclick="invoice_productList(1)" id="product_name_1" class="form-control productSelection" placeholder="Search product">
                                ...
                                <td>
                                    <input type="text" name="product_quantity[]" required="" onkeyup="japasys_invoice_quantity_calculate(1);" onchange="japasys_invoice_quantity_calculate(1);" class="total_qntt_1 form-control text-right" id="total_qntt_1" placeholder="0.00" min="0" tabindex="8" value="1" />
                                </td>
                                <td class="invoice_fields">
                                    <input type="text" name="product_rate[]" id="price_item_1" class="price_item1 price_item form-control text-right" tabindex="9" required="" onkeyup="japasys_invoice_quantity_calculate(1);" onchange="japasys_invoice_quantity_calculate(1);" placeholder="0.00" min="0" />
                                </td>
                                <!-- Discount -->
                                <td>
                                    <input type="text" name="discount[]" onkeyup="japasys_invoice_quantity_calculate(1);" onchange="japasys_invoice_quantity_calculate(1);" id="discount_1" class="form-control text-right" min="0" tabindex="10" placeholder="0.00" />
                                ...
                                <!-- VAT  -->
                                <td>
                                    <input type="text" name="vatpercent[]" onkeyup="japasys_invoice_quantity_calculate(1);" onchange="japasys_invoice_quantity_calculate(1);" id="vat_percent_1" class="form-control text-right" min="0" tabindex="19" placeholder="0.00" />
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" onkeyup="japasys_invoice_quantity_calculate(1);" onchange="japasys_invoice_quantity_calculate(1);" id="invoice_discount" class="form-control text-right total_discount" name="invoice_discount" placeholder="0.00" tabindex="13" />
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" id="shipping_cost" class="form-control text-right" name="shipping_cost" onkeyup="japasys_invoice_quantity_calculate(1);" onchange="japasys_invoice_quantity_calculate(1);" placeholder="0.00" tabindex="14" />
                                </td>
                            </tr>
                            <tr>
