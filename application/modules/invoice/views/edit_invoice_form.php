...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <?php echo form_open('invoice/invoice/japasys_update_invoice', array('class' => 'form-vertical', 'id' => 'update_invoice')) ?>
            <div class="panel-body">

                <div class="row">
                    <div class="col-sm-6" id="payment_from_1">
                        <div class="form-group row">
                            <label for="product_name" class="col-sm-3 col-form-label"><?php echo display('customer_name') . '/' . display('phone') ?>
                            ...
                            <div class="col-sm-6">
                                <select name="sales_by" class="form-control " id="sales_by">
                                    ...
                                    <?php foreach ($salesman as $gs) { ?>
                                        <option value="<?php echo html_escape($gs['user_id']) ?>" <?php if ($gs['user_id'] == $sales_by) {
                                                                                                        echo 'selected';
                                                                                                    } ?>>
                            ...
                            <div class="col-sm-6">
                                <select name="bank_id" class="form-control bankpayment" id="bank_id">
                                    ...
                                    <?php foreach ($bank_list as $bank) { ?>
                                        <option value="<?php echo html_escape($bank['bank_id']) ?>" <?php if ($bank['bank_id'] == $bank_id) {
                                                                                                        echo 'selected';
                                                                                                    } ?>>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                $date = date('Y-m-d');
                                ?>
                                <input class="datepicker form-control" type="text" size="50" name="due_date" id="date2" value="<?php echo html_escape($due_date); ?>" tabindex="4" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody id="addinvoiceItem">
                            ...
                            foreach ($invoice_all_data as $details) { ?>
                                <tr>
                                    ...
                                    <!-- VAT  -->
                                    <td>
                                        <input type="text" name="vatpercent[]" onkeyup="japasys_invoice_quantity_calculate(<?php echo $details['sl'] ?>);" onchange="japasys_invoice_quantity_calculate(<?php echo $details['sl'] ?>);" id="vat_percent_<?php echo $details['sl'] ?>" class="form-control text-right" min="0" tabindex="19" placeholder="0.00" value="<?php echo $details['vat_amnt_per'] ?>" />

                                    </td>
                                    <td>
                                        <input type="text" name="vatvalue[]" id="vat_value_<?php echo $details['sl'] ?>" class="form-control text-right total_vatamnt" min="0" tabindex="20" placeholder="0.00" value="<?php echo $details['vat_amnt'] ?>" readonly />
                                    </td>
                                    <!-- VAT end -->
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="10" rowspan="2">
                                    <center><label sclass="text-center" for="details" class="  col-form-label"><?php echo display('invoice_details') ?></label>
                                    </center>
                                    ...
                                    foreach ($multi_paytype as $all_paytype) { ?>
                                        <div class="row no-gutters">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" id="pamount_by_method" class="form-control number pay firstpay" name="pamount_by_method[]" value="<?php echo $all_paytype->Debit ?>" onkeyup="changedueamount()" placeholder="0" />
