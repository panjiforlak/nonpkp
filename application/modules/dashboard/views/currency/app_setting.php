         ...
         <div class="col-sm-12">
             <div class="panel panel-bd lobidrag">
                 ...
                 <table id="" class="table table-responsive">
                     <tr>
                         <td> <img src="<?php echo base_url('my-assets/image/qr/' . $qr_image) ?>" class="img-responsive center-block appsettingqr" alt="">
                 ...
                 <div class="panel-body">
                     <div class="row">
                         <div class="col-sm-8">
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                     ...
                                     <span class="text-danger">http://japasys.com/saleserp</span>
                                 </div>
                             </div>
                             <div class="form-group row">
                         ...
                         <div class="col-sm-4 playstorelink">
                             <a href="https://play.google.com/store/apps/details?id=com.japasys.pos" target="blank">
                                 <h3><b>Check our Sales ERP App Demo From </b> <br>
                                     <p class="text-center">Google Playstore</p>
                                 </h3>
                             </a>
