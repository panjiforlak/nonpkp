             ...
             <div class="panel-body">
                 ...
                 <?php
                    ...
                    foreach ($accounts as $key => $value) {
                        $account_sub = $this->db->select('*')->from('sub_module')->where(['mid' => $value['id'], 'status' => 1])->get()->result();
                    ?>
                     <table class="table table-sm table-bordered">
                         ...
                         <thead>
                             <tr>
                                 ...
                                 <th class="text-center"><?php echo display('create'); ?> (<label for="checkAllcreate<?php echo $m ?>"><input type="checkbox" onclick="checkallcreate(<?php echo $m ?>)" id="checkAllcreate<?php echo $m ?>" name=""> All)</label></th>
                                 <th class="text-center"><?php echo display('read'); ?> (<input type="checkbox" onclick="checkallread(<?php echo $m ?>)" id="checkAllread<?php echo $m ?>" name=""> all)</th>
                                 <th class="text-center"><?php echo display('update'); ?> (<input type="checkbox" onclick="checkalledit(<?php echo $m ?>)" id="checkAlledit<?php echo $m ?>" name=""> all)</th>
                                 <th class="text-center"><?php echo display('delete'); ?> (<input type="checkbox" onclick="checkalldelete(<?php echo $m ?>)" id="checkAlldelete<?php echo $m ?>" name=""> all)</th>
                             </tr>
                         </thead>
                         <?php $sl = 0 ?>
