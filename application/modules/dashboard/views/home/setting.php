        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('dashboard/setting/japasys_create_settings', array('class' => 'form-vertical', 'id' => 'insert_setting')) ?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="discount_type" class="col-sm-3 col-form-label"><?php echo display('invoice_qr_code') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input type="checkbox" name="is_qr" class="is-qr-pos" value="1" <?php if ($sdata->is_qr == 1) {
                                                                                                    echo 'checked';
                                                                                                } ?>>
                            </div>
                        </div>
