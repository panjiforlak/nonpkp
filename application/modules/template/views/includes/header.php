<a style="position: fixed;height:44px;line-height:44px;background-color:#FFA500" href="<?php echo base_url('home') ?>" class="logo">
    <span class="logo-lg">
        <b style="color: black;">NON PKP</b> ERP<sup>v1.2</sup>
...
if ($gui_p != 'gui_pos') {
?>
    <nav class="navbar " style="position: fixed;right:0;left:0;top:0;height:45px;min-height:45px;background-color:#FFA500">
        ...
        <span class="top-fixed-links">
            ...
            ?>
                <a style="margin-top:5px" href="<?php echo base_url('add_invoice') ?>" class="btn btn-sm btn-black"><i class="fa fa-shopping-bag"></i> <?php echo display('invoice') ?></a>
            <?php } ?>


            <?php if ($this->permission1->method('customer_receive', 'create')->access()) { ?>
                <a style="margin-top:5px" href="<?php echo base_url('customer_receive') ?>" class="btn btn-sm btn-black "><i class="fa fa-money"></i> <?php echo display('customer_receive') ?></a>
            <?php } ?>

            <?php if ($this->permission1->method('supplier_payment', 'create')->access()) { ?>
                <a style="margin-top:5px" href="<?php echo base_url('supplier_payment') ?>" class="btn btn-sm btn-black "><i class="fa fa-money" aria-hidden="true"></i> <?php echo display('supplier_payment') ?></a>
            <?php } ?>

            <?php if ($this->permission1->method('add_purchase', 'create')->access()) { ?>
                <a style="margin-top:5px" href="<?php echo base_url('add_purchase') ?>" class="btn btn-sm btn-black "><i class="ti-shopping-cart"></i> <?php echo display('purchase') ?></a>
            <?php } ?>
        </span>
        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav" style="margin-top:0px">
                ...
                ?>
                    <li>
                        <a style="margin-top:5px" href="<?php echo base_url('gui_pos') ?>" class="text-white btn-sm btn-primary pos-btn"> <span class="fa fa-plus"></span> <?php echo display('pos_invoice') ?></a>
                    </li>
                <?php } ?>
