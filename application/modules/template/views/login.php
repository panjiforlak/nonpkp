...
<body style="
    background: url(<?php echo site_url('assets/images/16052.jpg'); ?>);
    ...
    <div class="container-center">
        ...
        <div class="panel panel-bds" style="box-shadow: 0px 0 30px rgba(1, 41, 112, 0.1);border-radius:20px">
            <div class="panel-heading ">
                ...
                <div class="row" style="margin: 2px; margin-bottom:0px;font-size:12px">

                    <!-- alert message -->
                    <?php if ($this->session->flashdata('message') != null) {  ?>
                        <div class="alert alert-info alert-dismissable">
                            <button type="button" class="close text-primary" data-dismiss="alert" aria-hidden="true">&times;</button>
            ...
            <div class="panel-body" style="padding-top: 10px;">
                ...
                <div class="text-center">
                    <button class="btn btn-primary" style="border-radius: 10px;"><?php echo display('login') ?></button>
                </div>
                <?php echo form_close() ?>
            </div>
