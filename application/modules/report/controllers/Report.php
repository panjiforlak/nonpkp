...
class Report extends MX_Controller
{
    ...
    public function japasys_checkStocklist()
    {
        // GET data
        $postData = $this->input->post();
        $data = $this->report_model->japasys_getStock($postData);
        echo json_encode($data);
    }


    public function japasys_cash_closing()
    {
    ...
    public function japasys_closing_report()
    {
    ...
    public function japasys_closing_report_search()
    {
    ...
    public function japasys_todays_report()
    {
    ...
    public function japasys_target_report()
    {
        ...
        $data['get_tproduct'] = $this->report_model->get_period_and_product('', $stoday, $gyear);
        ...
        $data['get_target_product']   = $this->report_model->get_target_product($data['get_tproduct']->id);
        $data['module']   = "report";
    ...
    //    ============ its for todays_customer_receipt =============
    public function japasys_customerwise_received()
    {
    ...
    public function japasys_todays_sales_report()
    {
        $sales_report = $this->report_model->todays_sales_report();
        $sales_amount = 0;
        if (!empty($sales_report)) {
    ...
    public function japasys_datewise_sales_report()
    {
        $from_date = $this->input->get('from_date');
        $to_date  = $this->input->get('to_date');
    ...
    public function japasys_userwise_sales_report()
    {
    ...
    public function japasys_invoice_wise_due_report()
    {
    ...
    public function japasys_shippingcost_report()
    {
        $from_date = (!empty($this->input->get('from_date')) ? $this->input->get('from_date') : date('Y-m-d'));
        $to_date = (!empty($this->input->get('to_date')) ? $this->input->get('to_date') : date('Y-m-d'));
    ...
    public function japasys_purchase_report()
    {
        $from_date = (!empty($this->input->get('from_date')) ? $this->input->get('from_date') : date('Y-m-d'));
        $to_date = (!empty($this->input->get('to_date')) ? $this->input->get('to_date') : date('Y-m-d'));
        $purchase_report = $this->report_model->japasys_purchase_report($from_date, $to_date);
        $purchase_amount = 0;
    ...
    public function japasys_purchase_report_category_wise()
    {
        $from_date = (!empty($this->input->get('from_date')) ? $this->input->get('from_date') : date('Y-m-d'));
        $to_date   = (!empty($this->input->get('to_date')) ? $this->input->get('to_date') : date('Y-m-d'));
    ...
    public function japasys_sale_report_productwise()
    {
        $from_date = (!empty($this->input->get('from_date')) ? $this->input->get('from_date') : date('Y-m-d'));
        $to_date = (!empty($this->input->get('to_date')) ? $this->input->get('to_date') : date('Y-m-d'));
    ...
    public function japasys_categorywise_sales_report()
    {
        $from_date = (!empty($this->input->get('from_date')) ? $this->input->get('from_date') : date('Y-m-d'));
        $to_date = (!empty($this->input->get('to_date')) ? $this->input->get('to_date') : date('Y-m-d'));
        $category = (!empty($this->input->get('category')) ? $this->input->get('category') : '');
    ...
    public function japasys_sales_return()
    {
        $from_date = $this->input->post('from_date', TRUE);
    ...
    public function japasys_supplier_return()
    {
        $from_date = $this->input->post('from_date', TRUE);
        $to_date   = $this->input->post('to_date', TRUE);
        $start     = (!empty($from_date) ? $from_date : date('Y-m-d'));
    ...
    public function japasys_tax_report()
    {
        $from_date = (!empty($this->input->get('from_date')) ? $this->input->get('from_date') : date('Y-m-d'));
        $to_date = (!empty($this->input->get('to_date')) ? $this->input->get('to_date') : date('Y-m-d'));
    ...
    public function japasys_profit_report()
    {
    ...
    public function japasys_add_closing()
    {
