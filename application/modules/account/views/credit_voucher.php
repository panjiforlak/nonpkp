    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo  form_open_multipart('account/account/japasys_create_credit_voucher', 'id="validate"') ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <select name="cmbDebit" id="cmbDebit" class="form-control" required="">
                            <option value='111000001'>Kas ditangan</option>
                            <?php foreach ($listkas as $cracc) { ?>
                                <!-- perubahan crcc jadi listkas -->
                                ...
                                <td class="" width="200p">
                                    <select name="cmbCode[]" id="cmbCode_1" class="form-control" onchange="load_dbtvouchercode(this.value,1)" required="">
                                        ...
                                        <?php foreach ($acc as $acc1) { ?>
                                            <option value="<?php echo html_escape($acc1->HeadCode); ?>"><?php echo html_escape($acc1->account_name_indo) ?: html_escape($acc1->HeadName); ?></option>
                                            <!-- perubahan : html_escape($acc1->HeadName) jadi html_escape($acc1->account_name_indo)?:html_escape($acc1->HeadName); -->
                                        <?php } ?>
                                    </select>
