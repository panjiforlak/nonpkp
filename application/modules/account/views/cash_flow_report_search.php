      ...
      <div id="printArea">
        <div class="panel-body">
          <div>
            ...
            <table width="100%" class="table_boxnew table-hover" cellpadding="0" cellspacing="0">
              <tr>
              ...
              ?>
                  <tr>
                    <!-- perubahan : sebelumnya  $oResultAsset[$i]->HeadName -->
                    <td align="left" class="paddingleft10px"><?php echo $oResultAsset[$i]->account_name_indo ?: $oResultAsset[$i]->HeadName; ?></td>
                    <td>&nbsp;</td>
              ...
              <tr>
                <td align="left" class="paddingleftright10"><strong>Total Kas Pembukaan & Setara Kas</strong></td>
                <td>&nbsp;</td>
                <td align="right" class="totalopeninig"><strong><?php echo number_format($TotalOpening); ?></strong></td>
              </tr>
              <tr class="table_head">
                <td colspan="3" class="padddingwithunderline"><b>Arus Kas dari Aktivitas Operasional</b></td>
              </tr>
              <?php
              $TotalCurrAsset = 0;
              ...
              ?>
                  <tr>
                    <!-- perubahan : sama seperti yang lain -->
                    <td align="left" class="paddingleft10px"><?php echo $oResultCurrAsset[$s]->account_name_indo ?: $oResultCurrAsset[$s]->HeadName; ?></td>
                    <td>&nbsp;</td>
              ...
              if ($oResultAmount->Amount != 0) {
                ?>
                <tr>
                  <td align="left" class="paddingleft10px">Pembayaran untuk Kegiatan Operasi Lainnya</td>
                  <td>&nbsp;</td>
              ...
              <tr>
                <td align="left" class="paddingleftright10"><strong>Kas yang dihasilkan dari Aktivitas Operasional sebelum Perubahan Aset & Kewajiban </strong></td>
                <td>&nbsp;</td>
                <td align="right" class="totalopeninig"><strong><?php echo number_format($TotalCurrAsset); ?></strong></td>
              </tr>

              <tr class="table_head">
                <td colspan="3" class="padddingwithunderline"><b>Arus Kas dari Aktivitas Non Operasional</b></td>
              </tr>
              <?php
              $TotalCurrAssetNon = 0;
              ...
              <tr>
                <td align="left" class="paddingleftright10"><strong>Kas yang dihasilkan dari Aktivitas Non Operasional sebelum Perubahan Aset dan Kewajiban </strong></td>
                <td>&nbsp;</td>
              ...
              <tr class="table_head">
                <td align="left" class="paddingleftright10"><strong>Kenaikan/Penurunan Aset Operasi & Kewajiban</strong></td>
                <td>&nbsp;</td>
              ...
              ?>
                  <tr>
                    <!-- perubahan -->
                    <td align="left" class="paddingleft10px"><?php echo $oResultLiab[$t]->account_name_indo ?: $oResultLiab[$t]->HeadName; ?></td>
                    <td>&nbsp;</td>
              ...
              <tr>
                <td align="left" class="paddingleftright10"><strong>Peningkatan/Penurunan Total</strong></td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td align="left" class="paddingleftright10"><strong>Kas Bersih Dari Aktivitas Operasi/Non Operasional</strong></td>
                <td>&nbsp;</td>
              ...
              <tr class="table_head">
                <td colspan="3" class="padddingwithunderline"><b>Arus Kas dari Aktivitas Investasi</b></td>
              </tr>
              <?php
              $TotalNonCurrAsset = 0;
              ...
              ?>
                  <tr>
                    <!-- perubahan -->
                    <td align="left" class="paddingleft10px"><?php echo $oResultNonCurrAsset[$t]->account_name_indo ?: $oResultNonCurrAsset[$t]->HeadName; ?></td>
                    <td>&nbsp;</td>
              ...
              <tr>
                <td align="left" class="paddingleftright10"><strong>Kas Bersih Digunakan untuk Aktivitas Investasi</strong></td>
                <td>&nbsp;</td>
              ...
              <tr class="table_head">
                <td colspan="3" class="padddingwithunderline"><b>Arus Kas dari Aktivitas Pendanaan</b></td>
              </tr>
              <?php
              $TotalNonCurrLiab = 0;
              ...
              ?>
                  <tr>
                    <!-- perubahan -->
                    <td align="left" class="paddingleft10px"><?php echo $oResultNonCurrLiab[$t]->account_name_indo ?: $oResultNonCurrLiab[$t]->HeadName; ?></td>
                    <td>&nbsp;</td>
              ...
              ?>
                  <tr>
                    <!-- perubahan -->
                    <td align="left" class="paddingleft10px"><?php echo $oResultFund[$t]->account_name_indo ?: $oResultFund[$t]->HeadName; ?></td>
                    <td>&nbsp;</td>
                    <td align="right" class="cashflowamnt">
                      <?php
                      $Total = $oResultAmount->Amount;
              ...
              <tr>
                <td align="left" class="paddingleftright10"><strong>Kas Bersih Digunakan untuk Aktivitas Pendanaan</strong></td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td align="left" class="paddingleft10px"><strong>Kas Bersih Masuk/Keluar (Laba Rugi <?php echo number_format($TotalCurrAsset + $TotalCurrAssetNon + $TotalCurrLiab + $TotalNonCurrAsset + $TotalFund + $TotalNonCurrLiab); ?>)</strong></td>
                <td>&nbsp;</td>
              ...
              <tr class="table_head">
                <td colspan="3" class="paddingleft10px"><strong>Menutup Kas & Setara Kas:</strong></td>
              </tr>
              <?php
              $sql = "SELECT * FROM acc_coa WHERE acc_coa.IsTransaction=1 AND acc_coa.HeadType='A' AND acc_coa.IsActive=1 AND acc_coa.HeadCode LIKE '111000%' ";
              ...
              <tr>
                <td align="left" class="paddingleftright10"><strong>Total Menutup Kas & Setara Kas</strong></td>
                <td>&nbsp;</td>
