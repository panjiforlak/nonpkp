                ...
                <div class="panel-body">
                    <div>
                        ...
                        <table width="100%" class="table_boxnew" style="padding: 5px">
                            ...
                            <tr class="table_head">
                                <td colspan="3" align="center" style="padding-left:10px"><b>On
                                        <?php echo $dtpFromDate; ?> To <?php echo $dtpToDate; ?></b></td>
                            </tr>
                            <tr class="table_head">
                                <td width="73%" height="29" align="center" style="padding-left:10px; border:1px solid #000;">
                                    <b><?php echo display('particulars'); ?></b>
                                </td>
                                <td width="2%">&nbsp;</td>
                                <td width="30%" align="right" style="padding-left:10px; padding-right:10px;  border:1px solid #000;;">
                            ...
                            ?>
                                    <tr>
                                        <td align="left" style="padding-left:10px"><?php echo $oResultAsset[$i]->HeadName; ?>
                                        </td>
                                        <td>&nbsp;</td>
                            ...
                            <tr>
                                <td align="left" style="padding-left:10px;padding-right:10px"><strong>Total Uang Pembukaan dan Setara Kas</strong></td>
                                <td>&nbsp;</td>
                                <td align="right" style="padding-right:10px; border-top: solid 1px #000; border-bottom: solid 1px #000;">
                            ...
                            <?php
                            $TotalCurrAsset = 0;
                            $sql = "SELECT * FROM acc_coa WHERE IsGL=1 AND HeadCode LIKE '102%' AND IsActive=1 AND HeadCode NOT LIKE '111000%' AND HeadCode!='102' ";
                            ...
                            ?>
                                    <tr>
                                        <td align="left" style="padding-left:10px">
                                            <?php echo $oResultCurrAsset[$s]->HeadName; ?></td>
                                        <td>&nbsp;</td>
                            ...
                            ?>
                                    <tr>
                                        <td align="left" style="padding-left:10px"><?php echo $oResultLiab[$t]->HeadName; ?>
                                        </td>
                                        <td>&nbsp;</td>
                            ...
                            ?>
                                    <tr>
                                        <td align="left" style="padding-left:10px">
                                            <?php echo $oResultNonCurrAsset[$t]->HeadName; ?></td>
                                        <td>&nbsp;</td>
                            ...
                            ?>
                                    <tr>
                                        <td align="left" style="padding-left:10px">
                                            <?php echo $oResultNonCurrLiab[$t]->HeadName; ?></td>
                                        <td>&nbsp;</td>
                            ...
                            ?>
                                    <tr>
                                        <td align="left" style="padding-left:10px"><?php echo $oResultFund[$t]->HeadName; ?>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td align="right" style="padding-right:10px; border-left: solid 1px #000; border-right:solid 1px #000;">
                                            <?php
                            ...
                            <tr>
                                <td align="left" style="padding-left:10px;"><strong>Kas Bersih Masuk/Keluar (Laba Rugi
                            ...
                            <tr>
                                <td colspan="4" align="center">
                                    <table width="100%" cellpadding="1" cellspacing="20" style="margin-top: 50px">
                                        <tr>
                                            <td width="20%" style="border-top: solid 1px #000;" align="center">Prepared
                                                By</td>
                                            <td width="20%" style="border-top: solid 1px #000;" align="center">Accounts
                                            </td>
                                            <td width='20%' style='text-decoration:overline'>Authorized Signature</td>
                                            <td width="20%" style="border-top: solid 1px #000;" align='center'>Chairman
                                            </td>
                                        </tr>
                                    </table>
                                </td>
