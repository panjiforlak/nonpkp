    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo  form_open_multipart('account/account/japasys_create_debit_voucher', 'id="validate"') ?>
                    ...
                    <div class="col-sm-4">
                        <select name="cmbDebit" id="cmbDebit" class="form-control" required="">
                            ...
                            <?php foreach ($listkas as $cracc) { ?>
                                <!-- perubahan : $crcc diganti jadi $listkas -->
                                ...
                                <td class="" width="200">
                                    <select name="cmbCode[]" id="cmbCode_1" class="form-control" onchange="load_dbtvouchercode(this.value,1)" required="">
                                        ...
                                        <?php foreach ($acc as $acc1) { ?>
                                            <option value="<?php echo $acc1->HeadCode; ?>"><?php echo $acc1->account_name_indo ?: $acc1->HeadName; ?></option>
                                            <!-- perubahan : harusnya $acc1->HeadName diubah jadi $acc1->account_name_indo ?: $acc1->HeadName;-->
                                        <?php } ?>
                                    </select>
