    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo  form_open_multipart('account/account/japasys_add_opening_balance', 'id="validate"') ?>
                    ...
                    <div class="col-sm-4">
                        <select name="headcode" class="form-control" required="" tabindex="3">
                            ...
                            <?php foreach ($headss as $acc_head) { ?>
                                <option value="<?php echo $acc_head->HeadCode; ?>"><?php echo $acc_head->account_name_indo ?: $acc_head->HeadName; ?></option>
                                <!-- perubahan : sebelumnya "echo $acc_head->HeadName;" -->
                            <?php } ?>
                        </select>
                    </div>
