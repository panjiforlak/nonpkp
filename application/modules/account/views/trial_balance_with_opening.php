                    ...
                    <table width="100%" class="table table-bordered">
                        ...
                        ?>
                                <tr class="table_data">
                                    ...
                                    <!-- perubahan : ternary -->
                                    <td align="left" bgcolor="<?php echo $bg; ?>"><?php if ($oResultTr[$i]['account_name_indo']) {
                                                                                        if ($oResultTr[$i]['account_name_indo'] == 'Pemasok') {
                                                                                            echo 'Hutang Dagang';
                                                                                        } else {
                                                                                            echo $oResultTr[$i]['account_name_indo'];
                                                                                        }
                                                                                    } else {
                                                                                        echo $oResultTr[$i]['HeadName'];
                                                                                    } ?></td>
                                    <?php
                        ...
                        for ($i = 0; $i < count($oResultInEx); $i++) {
                            ...
                            if ($oResultTrial->Credit != $oResultTrial->Debit) {
                                ...
                                <tr class="table_data">
                                    ...
                                    <!-- perubahan: ternary -->
                                    <td align="left" bgcolor="<?php echo $bg; ?>"><?php echo $oResultInEx[$i]['account_name_indo'] ?: $oResultInEx[$i]['HeadName']; ?></td>
                                    <?php
                                    if ($oResultTrial->Debit > $oResultTrial->Credit) {
                                    ?>
                                        <td align="right" bgcolor="<?php echo $bg; ?>"><?php
                        ...
                        if ($ProfitLoss != 0) {
                            ...
                            <tr class="table_data">
                                ...
                                <td align="left" bgcolor="<?php echo $bg; ?>">Harga Pokok Persediaan</td>
                            <?php
                        }
                        if ($ProfitLoss < 0) {
                            ?>
