                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="product_id" type="text" id="product_id" placeholder="<?php echo display('barcode_or_qrcode') ?>" value="SKU-SJ<?php echo  html_escape($sku_no); ?>" tabindex="1" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control text-right" id="sell_price" name="price" type="text" required="" placeholder="0.00" tabindex="5" min="0" value="<?php echo $product->price ?: 0; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <tbody id="proudt_item">
                            <?php if (empty($supplier_pr)) { ?>
                                <tr>
                                    ...
                                    <td class="">
                                        <input type="text" tabindex="6" class="form-control text-right" name="supplier_price[]" placeholder="0.00" value="0" required min="0" />
                                    </td>
