...
class Product extends MX_Controller
{
    ...
    // category part
    function japasys_category_list()
    {
    ...
    public function japasys_category_form($id = null)
    {
    ...
    public function japasys_deletecategory($id = null)
    {
    ...
    public function japasys_unit_form($id = null)
    {
    ...
    public function japasys_deleteunit($id = null)
    {
    ...
    // product part
    public function japasys_product_form($id = null)
    {
        ...
        $data['product'] = (object)$postData = [
            ...
            'product_name'   => strtoupper($this->input->post('product_name', TRUE)),
        ...
        if ($this->form_validation->run() === true) {
            ...
            $data['sku_no']        = $this->number_generator();
            $data['module']        = "product";
    ...
    public function japasys_product_list()
    {
    ...
    public function japasys_deleteproduct($id = null)
    {
    ...
    public function japasys_csv_product()
    {
    ...
    public function qrgenerator($product_id)
    {
        ...
        $product_info = $this->product_model->japasys_barcode_productdata($product_id);
        $data = array(
    ...
    public function japasys_product_details($product_id = null)
    {
        $details_info = $this->product_model->japasys_barcode_productdata($product_id);
