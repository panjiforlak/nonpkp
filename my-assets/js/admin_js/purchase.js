...
function calculate_store(sl) {
  ...
  if (purchase_edit_page == 1) {
    ...
    var url = base_url + "purchase/purchase/japasys_showpaymentmodal";
    $.ajax({
      type: "post",
      url: url,
...
function product_pur_or_list(sl) {
  ...
  var options = {
    ...
    source: function (request, response) {
      ...
      $.ajax({
        url: base_url + "purchase/purchase/japasys_product_search_by_supplier",
        method: 'post',
        dataType: "json",
        data: {
          term: request.term,
    ...
    select: function (event, ui) {
      ...
      $.ajax({
        type: "POST",
        url: base_url + "purchase/purchase/japasys_retrieve_product_data",
