...
INSERT INTO `app_setting` (`id`, `localhserver`, `onlineserver`, `hotspot`) VALUES ('1', 'https://demo.japasys.com', 'https://demo.japasys.com', 'https://demo.japasys.com');
...
INSERT INTO `web_setting` (`setting_id`, `logo`, `invoice_logo`, `favicon`, `currency`, `timezone`, `currency_position`, `footer_text`, `language`, `rtr`, `captcha`, `is_qr`, `site_key`, `secret_key`, `discount_type`) VALUES ('1', '', '', '', '$', 'Asia/Dhaka', '0', 'Developed by  japasys', 'english', '0', '1', '1', '6LdiKhsUAAAAAMV4jQRmNYdZy2kXEuFe1HrdP5tt', '6LdiKhsUAAAAAMV4jQRmNYdZy2kXEuFe1HrdP5tt', '1');
