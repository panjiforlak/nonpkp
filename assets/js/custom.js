...
$(document).ready(function () {
  ...
  $('#checkListStockList').DataTable({
    ...
    'serverMethod': 'post',
    'ajax': {
      'url': base_url + 'report/report/japasys_checkStocklist',
      data: {
...
$(document).ready(function () {
  ...
  var mydatatable = $('#CustomerList').DataTable({
    ...
    'serverMethod': 'post',
    'ajax': {
      'url': base_url + 'customer/customer/japasys_CheckCustomerList',
      "data": function (data) {
...
function customerdelete(id) {
  ...
  if (r == true) {
    $.ajax({
      url: base_url + "customer/customer/japasys_delete/" + id,
      type: "GET",
      success: function (r) {
        toastr["success"](r);
        setTimeout(function () {
...
$(document).ready(function () {
  ...
  var mydatatable = $('#Credit_customerList').DataTable({
    ...
    'serverMethod': 'post',
    'ajax': {
      'url': base_url + 'customer/customer/japasys_CheckCreditCustomerList',
      "data": function (data) {
        data.csrf_test_name = CSRF_TOKEN;
        data.customer_id = $('#customer_id').val();
        data.customfiled = $("select[name='customsearch[]']").val();
...
$(document).ready(function () {
  ...
  var mydatatable = $('#paid_CustomerList').DataTable({
    ...
    'serverMethod': 'post',
    'ajax': {
      'url': base_url + 'customer/customer/japasys_CheckPaidCustomerList',
      "data": function (data) {
        data.csrf_test_name = CSRF_TOKEN;
        data.customer_id = $('#customer_id').val();
        data.customfiled = $("select[name='customsearch[]']").val();
...
$(document).ready(function () {
  ...
  var mydatatable = $('#supplierList').DataTable({
    ...
    'serverMethod': 'post',
    'ajax': {
      'url': base_url + 'supplier/supplier/japasys_ChecksupplierList',
      "data": function (data) {
        data.csrf_test_name = CSRF_TOKEN;
...
function supplierdelete(id) {
  ...
  if (r == true) {
    $.ajax({
      url: base_url + "supplier/supplier/japasys_delete/" + id,
      type: "GET",
      success: function (r) {
        toastr["success"](r);
        setTimeout(function () {
