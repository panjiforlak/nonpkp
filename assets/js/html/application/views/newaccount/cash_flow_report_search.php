                                ...
                                <table width="100%" class="table_boxnew" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td colspan="3" align="center">
                                            <h2 style="margin: 0;"><?php echo display('cash_flow_statement'); ?> </h2>
                                        </td>
                                    </tr>
                                    <tr class="table_head">
                                    ...
                                    <tr>
                                        <td align="left" style="padding-left:10px;padding-right:10px"><strong>Total Kas Pembukaan & Setara Kas</strong></td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr class="table_head">
                                        <td colspan="3" style="padding-left:10px;text-decoration:underline"><b>Arus Kas dari Aktivitas Operasional</b></td>
                                    </tr>
                                    <?php
                                    $TotalCurrAsset = 0;
                                    ...
                                    if ($oResultAmount->Amount != 0) {
                                        ?>
                                        <tr>
                                            <td align="left" style="padding-left:10px">Pembayaran untuk Kegiatan Operasi Lainnya</td>
                                            <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td align="left" style="padding-left:10px;padding-right:10px"><strong>Kas yang dihasilkan dari Aktivitas Operasional sebelum Perubahan Aset & Kewajiban &amp; Liabilities</strong></td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr class="table_head">
                                        <td colspan="3" style="padding-left:10px;text-decoration:underline"><b>Arus Kas dari Aktivitas Non Operasional</b></td>
                                    </tr>
                                    <?php
                                    $TotalCurrAssetNon = 0;
                                    ...
                                    <tr>
                                        <td align="left" style="padding-left:10px;padding-right:10px"><strong>Kas yang dihasilkan dari Aktivitas Non Operasional sebelum Perubahan Aset dan Kewajiban &amp; Liabilities</strong></td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr class="table_head">
                                        <td align="left" style="padding-left:10px;padding-right:10px"><strong>Kenaikan/Penurunan Aset Operasi & Kewajiban</strong></td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td align="left" style="padding-left:10px;padding-right:10px"><strong>Peningkatan/Penurunan Total</strong></td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td align="left" style="padding-left:10px;padding-right:10px"><strong>Kas Bersih Dari Aktivitas Operasi/Non Operasional</strong></td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr class="table_head">
                                        <td colspan="3" style="padding-left:10px;text-decoration:underline"><b>Arus Kas dari Aktivitas Investasi</b></td>
                                    </tr>
                                    <?php
                                    $TotalNonCurrAsset = 0;
                                    ...
                                    <tr>
                                        <td align="left" style="padding-left:10px;padding-right:10px"><strong>Kas Bersih Digunakan untuk Aktivitas Investasi</strong></td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr class="table_head">
                                        <td colspan="3" style="padding-left:10px;text-decoration:underline"><b>Arus Kas dari Aktivitas Pendanaan</b></td>
                                    </tr>
                                    <?php
                                    $TotalNonCurrLiab = 0;
                                    ...
                                    <tr>
                                        <td align="left" style="padding-left:10px;padding-right:10px"><strong>Kas Bersih Digunakan untuk Aktivitas Pendanaan</strong></td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td align="left" style="padding-left:10px;"><strong>Kas Bersih Masuk/Keluar (Laba Rugi <?php echo number_format($TotalCurrAsset + $TotalCurrAssetNon + $TotalCurrLiab + $TotalNonCurrAsset + $TotalFund + $TotalNonCurrLiab); ?>)</strong></td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr class="table_head">
                                        <td colspan="3" style="padding-left:10px"><strong>Menutup Kas & Setara Kas:</strong></td>
                                    </tr>
                                    <?php
                                    $sql = "SELECT * FROM acc_coa WHERE acc_coa.IsTransaction=1 AND acc_coa.HeadType='A' AND acc_coa.IsActive=1 AND acc_coa.HeadCode LIKE '1020101%' ";
                                    ...
                                    <tr>
                                        <td align="left" style="padding-left:10px;padding-right:10px"><strong>Total Menutup Kas & Setara Kas</strong></td>
                                        <td>&nbsp;</td>
